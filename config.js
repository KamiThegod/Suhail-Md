...
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2438061982806";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Kami👑 (⁠눈⁠‸⁠눈⁠)",
  packname: process.env.PACK_NAME || "kami👑神",
  botname : process.env.BOT_NAME  || "sᴜʜᴀɪʟ-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "kami👑神",
